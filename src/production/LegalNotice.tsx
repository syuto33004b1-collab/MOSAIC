...
const PATHS = [
  ...
  {
    name: "Webhook",
    detail: "登録した HTTPS の宛先へ、ワークスペースの保存と業務データの変更を積みます。配信は、その組織への認証済み外部 API リクエストのときに試みます。外部 API が呼ばれない間は、積んだまま残ることがあります。",
  },
  {
    name: "外部API",
  ...
  {
    name: "Remote MCP",
    detail: "発行した連携資格を持つ外部の AI ホストが、ワークスペースを参照できます。気づきの送信は、ホスト側で確認トークンを渡したあとだけ受け付けます。ホストが確認を人に見せるかは、この画面では約束しません。",
  },
  {
    name: "Google ログイン",
    detail: "Google ログインでは、Google を身元提供者として認証します。ブラウザが Google の同意画面へ渡り、メール・氏名など Google アカウントの識別情報が Supabase Auth へ戻ります。この経路では配員・稼働などの業務データを Google へ送りません。会話と業務データをモデル提供者へ渡す経路は、上の「AI秘書」行を正とします。ボタンは、この配信で Google ログインが有効なときにだけ出ます。公開サインアップは無効です。",
  },
] as const;
